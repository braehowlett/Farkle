...
public:
    ...
    void playersToEnterGame()
    {
        ...
        cout << "All players have entered. Only one may win. Initialize!" << endl << endl;
    }
    ...
    void eachPlayerGame(int i)
    {
        ...
        int score = 0;
        cout << players[i].getName() << " rolls the dice: " << endl;
        dice.rollTheDice();
        dice.displayDice();
        score = dice.getRoundScore();
        cout << "\t Points Scored: " << score << endl;
    ...
    void playTheGame()
    {
        ...
        // display the winner
        cout << endl << players[index].getName() << " wins!" << endl;
    }
};
...
int main(string* players[])
{
    ...
    cout << endl << endl << "Number of players that would like to play the game? ";
    cin >> numPlayers;
    while (numPlayers < 2)
    {
        cin.clear();
